...
| 2026-07-19 | [Shaken Fist VDI console tokens](/components/kerbside/plans/PLAN-kerbside-vdi-tokens/) | Cross-repo plan (master in shakenfist's docs/plans/): per-instance console authorisation via short-lived Ed25519-signed tokens minted by Shaken Fist and validated offline by kerbside; kerbside side adds an `/sf-console.vv` exchange endpoint mirroring the Nova flow, a jti replay table, cluster-wide scraping, and host_subject for SF consoles | In progress | [phase 5](/components/kerbside/plans/PLAN-kerbside-vdi-tokens-phase-05-exchange/) (done), [phase 6](/components/kerbside/plans/PLAN-kerbside-vdi-tokens-phase-06-scrape/) (done), [phase 7](/components/kerbside/plans/PLAN-kerbside-vdi-tokens-phase-07-ci/) (done, SF mint-path test; kerbside exchange lane moved to phase 9), [phase 8](/components/kerbside/plans/PLAN-kerbside-vdi-tokens-phase-08-docs/) (done), [phase 9](/components/kerbside/plans/PLAN-kerbside-vdi-tokens-phase-09-e2e/) (planned, awaiting review) — post-merge cross-repo e2e + kerbside exchange lane; all four PRs now merged on develop |
