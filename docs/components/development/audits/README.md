...
| [npm-pin-indirect-dependencies.md](/components/development/audits/npm-pin-indirect-dependencies/) | package-lock.json is committed, lockfileVersion 2 or later, and honoured by CI |
...
| [plan-audit-phase.md](/components/development/audits/plan-audit-phase/) | Master plans end with a phase that runs PUSH-AUDIT.md over the whole plan's work |
