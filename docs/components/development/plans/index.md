...
| 2026-08-24 | [Push audit phase](/components/development/plans/PLAN-push-audit-phase/) | Give the pre-push audit a trigger: a mandatory final phase in every master plan, and a consistency check that nothing drops the reference. The review point confirmed the phase stays mandatory; the fleet backfill swept six repositories and recorded each plan's landing commits in those and this one, and found that the survey's repository list was narrower than the fleet. Only the push audit itself remains | In progress |
...
| 2026-09-11 | [TypeScript onboarding](/components/development/plans/PLAN-typescript-onboarding/) | Bring hunkydory, the fleet's first TypeScript repository, under the consistency audits and human review, deciding what the conventions mean for npm, linting and the runner images | In progress |
| 2026-09-13 | [Image supply chain](/components/development/plans/PLAN-image-supply-chain/) | Close the end-of-life migration and the five silent image-production failures behind it, in an order that does not break CI, and stop the audit being blind to the producers | In progress |
