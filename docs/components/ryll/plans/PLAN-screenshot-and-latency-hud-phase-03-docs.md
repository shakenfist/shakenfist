...
- The README features list at
  [README.md:6-28](/components/ryll/plans/README/) uses bold-prefixed bullets
...
- There are no docs in `docs/` that describe individual
  ...
  [README.md:149-162](/components/ryll/plans/README/) is for command-line flags
