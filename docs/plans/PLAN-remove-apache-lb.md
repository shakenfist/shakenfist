...
| Phase | Plan | Status |
|-------|------|--------|
| 1. Document operator-provided load balancing (example apache2 + nginx configs, single-node escape hatch) | PLAN-remove-apache-lb-phase-01-docs.md | Not started |
| 2. Remove Apache from the deployer; repoint single-node `api_url` to `:13000` | PLAN-remove-apache-lb-phase-02-remove.md | Not started |
