...
| [Remove the Apache load balancer](PLAN-remove-apache-lb.md) | [Phase 1: Document operator-provided LB](PLAN-remove-apache-lb-phase-01-docs.md) | Not started | Example apache2 + nginx configs and the `localhost:13000` single-node escape hatch (realises remove-primary phase 3) |
| [Remove the Apache load balancer](PLAN-remove-apache-lb.md) | [Phase 2: Remove Apache from the deployer](PLAN-remove-apache-lb-phase-02-remove.md) | Not started | Delete `apache2.yml` + `apache-site-primary.conf`; repoint single-node `api_url` to `:13000` |
