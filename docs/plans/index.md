...
| 2026-08-14 | [Agent operation deadlines](PLAN-agent-operation-deadlines.md) | Client-propagated deadlines and per-command progress timeouts for agent operations | In progress | 4 of 9 |
...
| 2026-08-27 | [Right-size the CI test clouds](PLAN-ci-cloud-sizing.md) | Measured sizing for the nested CI clouds, with headroom instrumentation and explicit saturation coverage before any cloud grows | In progress | 0 of 7 |
