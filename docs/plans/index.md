...
| [Remove the Apache load balancer](PLAN-remove-apache-lb.md) | Phase 2: Remove Apache from the deployer | Not started | Delete `apache2.yml` + `apache-site-primary.conf`; repoint single-node `api_url` to `:13000` |
