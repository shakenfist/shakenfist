...
| [Remove syslog forwarding (ship logs to Loki)](PLAN-remove-syslog-forwarding.md) | Phase 0: Decisions and design | Not started | Config surface, Loki label/field-name contract, spool factoring, auth, CI Loki topology (delivers the Loki-shipper story remove-primary phase 1 awaits) |
