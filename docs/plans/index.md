...
| [Remove the Apache load balancer](PLAN-remove-apache-lb.md) | Phase 1: Document operator-provided LB | Not started | Example apache2 + nginx configs and the `localhost:13000` single-node escape hatch (realises remove-primary phase 3) |
