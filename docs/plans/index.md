...
| 2026-05-24 | [Queue performance and coalescing](PLAN-queue-performance.md) | Batched dequeue and cluster-operation coalescing, measured: the wait tail is gone and explicit fairness was not needed, now under a retrospective push audit | In progress | 7 of 8 |
