...
| Phase | Plan | Status |
|-------|------|--------|
| 1. Query infrastructure | PLAN-sql-pushdown-filtering-phase-01-infrastructure.md | Not started |
| 2. Artifact pushdown | PLAN-sql-pushdown-filtering-phase-02-artifact.md | Not started |
| 3. Instance and Network pushdown | PLAN-sql-pushdown-filtering-phase-03-instance-network.md | Not started |
