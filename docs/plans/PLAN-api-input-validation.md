...
Phase 2 landed across three, #3666, #3682 and #3685, which were
parts 1, 2 and 3 of that phase; #3682 was missing from this table
until phase 8's survey found it, and is the change that collapsed
each operation's body parameters into one schema-carrying
parameter, which the whole compiled path is built on. Phase 4
landed across two pull requests, #4101 and #4141.
