...
''')
    ...
    out.append('''
      ...
      # The cluster total, measured against modelled. This pair is what
      # the "Database tier load" panel in examples/grafana-dashboard.json
      # draws, and is the quickest way to see whether load has moved for
      # a reason the model already knows about.
