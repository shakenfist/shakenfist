...
def _get_stats():
    ...
    memory_status = conn.getMemoryStats(libvirt.VIR_NODE_MEMORY_STATS_ALL_CELLS)
    retval.update(
        {
    ...
    node_queue_processing, node_queue_waiting = db.get_queue_length(config.NODE_NAME)
