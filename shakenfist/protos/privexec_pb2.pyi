...
class PrivExecRequest(_message.Message):
    __slots__ = ("execute_request", "hash_file_request")
    ...
    def __init__(self, execute_request: _Optional[_Union[_common_pb2.ExecuteRequest, _Mapping]] = ..., hash_file_request: _Optional[_Union[HashFileRequest, _Mapping]] = ...) -> None: ...

class PrivExecReply(_message.Message):
    __slots__ = ("execute_reply", "hash_file_reply")
    ...
    def __init__(self, execute_reply: _Optional[_Union[_common_pb2.ExecuteReply, _Mapping]] = ..., hash_file_reply: _Optional[_Union[HashFileReply, _Mapping]] = ...) -> None: ...
