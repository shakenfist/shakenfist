...
from shakenfist.etcd_schema.operations.net_macaddr_ip_op import create_and_enqueue
from shakenfist.etcd_schema.operations.net_macaddr_ip_op import current_version
from shakenfist.etcd_schema.operations.net_macaddr_ip_op import model
from shakenfist.etcd_schema.operations.net_macaddr_ip_op import model_tasks
    ...
    def test_create_and_enqueue(self, _mock_time, _mock_id):
        ...
        self.assertEqual(
            ...
            self.mock_etcd.get_raw(
                f'/sf/attribute/net_macaddr_ip_op/{op_uuid}/state')
        )
        self.assertEqual(
            {
