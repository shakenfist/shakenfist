...
class DBTestCase(test_shakenfist.ShakenFistTestCase):
    ...
    @mock.patch(
        "shakenfist.etcd.get", return_value={"uuid": "uuid42", "state": "initial"}
    )
    @mock.patch("shakenfist.etcd.put")
    ...
    @mock.patch(
        "shakenfist.etcd.get", return_value={"uuid": "uuid42", "state": "created"}
    )
    @mock.patch("shakenfist.etcd.put")
    ...
    @mock.patch(
        "shakenfist.etcd.get", return_value={"uuid": "uuid42", "power_state": "on"}
    )
    @mock.patch("shakenfist.etcd.put")
