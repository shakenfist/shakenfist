...
from shakenfist.schema.operations.net_iface_ip_op import current_version
from shakenfist.schema.operations.net_iface_ip_op import model
...
class NetIfaceIPOpTestCase(base.ShakenFistTestCase):
    ...
    def test_create_and_enqueue(self, _mock_time, _mock_id):
        ...
        self.assertEqual(
            ...
            self.mock_etcd.get_mariadb_state('net_iface_ip_op', op_uuid)
        )
        self.assertEqual(
            {
