...
from shakenfist.schema.operations.net_iface_op import current_version
from shakenfist.schema.operations.net_iface_op import model
...
class NetIfaceOpTestCase(base.ShakenFistTestCase):
    ...
    def test_create_and_enqueue(self, _mock_time, _mock_id):
        ...
        self.assertEqual(ObjectType.NET_IFACE_OP, op_type)
        ...
        self.assertEqual(
            ...
            self.mock_mariadb.get_mariadb_state('net_iface_op', op_uuid)
        )
        self.assertEqual(
            {
