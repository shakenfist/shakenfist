...
from shakenfist.schema.operations.node_inst_op import current_version
from shakenfist.schema.operations.node_inst_op import model
...
class NodeInstOpTestCase(base.ShakenFistTestCase):
    ...
    def test_create_and_enqueue(self, _mock_time, _mock_id):
        ...
        self.assertEqual(ObjectType.NODE_INST_OP, op_type)
        ...
        self.assertEqual(
            ...
            self.mock_mariadb.get_mariadb_state('node_inst_op', op_uuid)
        )
        self.assertEqual(
            {
